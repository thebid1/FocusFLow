...
export default defineConfig({
  // The app owns the root of its own subdomain (app.korgix.xyz); the marketing
  // landing page is deployed separately from appsite/ and owns korgix.xyz.
        ...
        shortcuts: [
          {
            ...
            url: '/?action=add',
            icons: [{ src: '/icons/Korgix.png', sizes: '192x192' }]
          }
        ],
        share_target: {
          action: '/?action=add',
